 ...
 */
class getArtisanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArtisanRepository' shared autowired service.
     *
     * @return \App\Repository\ArtisanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArtisanRepository.php';

        return $container->privates['App\\Repository\\ArtisanRepository'] = new \App\Repository\ArtisanRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
